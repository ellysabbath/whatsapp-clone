// import { View, Text, FlatList, Platform, TouchableOpacity, StyleSheet, Image, TextInput, StatusBar, Alert, Modal, Animated } from 'react-native';
// import { useRouter } from 'expo-router';
// import { Ionicons } from '@expo/vector-icons';
// import { useState, useRef, useEffect } from 'react';

// // Mock chat data - real conversations
// const chats = [
//   {
//     id: '1',
//     name: 'Sarah Johnson',
...
//     console.log(`Navigating to chat: ${chatName} (ID: ${chatId})`);
...
//             </Text>
//             {item.muted && (
//               <Ionicons name="notifications-off-outline" size={14} color="#999" style={styles.mutedIcon} />
//             )}
//           </View>
...
//       {/* Dropdown Menu - Complete Navigation */}
//       <Modal
//         transparent={true}
//         visible={menuVisible}
//         animationType="none"
...
//               onPress={() => handleMenuItem('newGroup')}
//               activeOpacity={0.7}
//             >
...
//             <TouchableOpacity 
//               style={styles.menuItem} 
//               onPress={() => handleMenuItem('newCommunity')}
//               activeOpacity={0.7}
//             >
//               <Ionicons name="globe-outline" size={22} color="#075E54" />
//               <Text style={styles.menuItemText}>New community</Text>
//             </TouchableOpacity>
            
//             <TouchableOpacity 
//               style={styles.menuItem} 
//               onPress={() => handleMenuItem('newBroadcast')}
//               activeOpacity={0.7}
//             >
...
//             <TouchableOpacity 
//               style={styles.menuItem} 
//               onPress={() => handleMenuItem('starredMessages')}
//               activeOpacity={0.7}
//             >
...
//             {/* Forms Section with proper icon */}
//             <TouchableOpacity 
//               style={styles.menuItem} 
//               onPress={() => handleMenuItem('forms')}
//               activeOpacity={0.7}
//             >
...
//             <TouchableOpacity 
//               style={styles.menuItem} 
//               onPress={() => handleMenuItem('createForm')}
//               activeOpacity={0.7}
//             >
...
//             <TouchableOpacity 
//               style={styles.menuItem} 
//               onPress={() => handleMenuItem('theme')}
//               activeOpacity={0.7}
//             >
//               <Ionicons name="color-palette-outline" size={22} color="#075E54" />
...
const styles = StyleSheet.create({
  ...
  bottomTab: {
    ...
    borderTopColor: '#e0e0e0',
    paddingVertical: 8,
    paddingBottom: Platform.OS === 'ios' ? 28 : 66,
    position: 'absolute',
    bottom: 0,
    left: 0,
    right: 0,
